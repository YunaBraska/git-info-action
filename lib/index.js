...
try {
    ...
    let result = run(workDir, ignoreFiles, branchFallback, tagFallback, !isEmpty(fallbackCommitType) ? fallbackCommitType : "", !isEmpty(fallbackCommitScope) ? fallbackCommitScope : "", !isEmpty(commitMsgWithFooter) ? commitMsgWithFooter.toLowerCase() === 'true' : true);
...
function getTicketNumbers(commits) {
    ...
    commits.forEach(commit => {
        var _a, _b;
        (_b = (_a = commit[3]) === null || _a === void 0 ? void 0 : _a.match(TICKET_PATTERN)) === null || _b === void 0 ? void 0 : _b.forEach(ticket => tickets.push(ticket.trim()));
    });
    return tickets;
}
