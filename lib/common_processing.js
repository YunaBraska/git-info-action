...
exports.execCmd = exports.toSemanticCommit = exports.toCommitMessages = exports.cmdLog = exports.cmd = exports.replaceNullWithEmptyMap = exports.sortMap = exports.deleteBranchPrefix = exports.getTicketNumbers = exports.isEmpty = exports.str = exports.TICKET_PATTERN = exports.BC_PATTERN = exports.LINE_SEPARATOR = void 0;
...
function getTicketNumbers(commits) {
    ...
    commits.forEach(commit => {
        var _a, _b;
        (_b = (_a = commit[3]) === null || _a === void 0 ? void 0 : _a.match(exports.TICKET_PATTERN)) === null || _b === void 0 ? void 0 : _b.forEach(ticket => tickets.push(ticket.trim()));
    });
    return tickets;
}
