...
export function addContext(result: Map<string, ResultType>, context: any) {
    ...
    //REPOSITORY
    result.set('repo_id', context?.payload?.repository?.id || null)
    result.set('repo_size', context?.payload?.repository?.size !== undefined ? context.payload.repository.size : null)
    result.set('repo_open_issues', context?.payload?.repository?.open_issues !== undefined ? context.payload.repository.open_issues : null)
    result.set('repo_star_count', context?.payload?.repository?.stargazers_count !== undefined ? context.payload.repository.stargazers_count : null)
    result.set('is_repo_fork', context?.payload?.repository?.fork !== undefined ? context.payload.repository.fork : null)
    result.set('is_repo_private', context?.payload?.repository?.private !== undefined ? context.payload.repository.private : null)
    result.set('is_repo_archived', context?.payload?.repository?.archived !== undefined ? context.payload.repository.archived : null)
    result.set('is_repo_disabled', context?.payload?.repository?.disabled !== undefined ? context.payload.repository.disabled : null)
    result.set('is_repo_template', context?.payload?.repository?.is_template !== undefined ? context.payload.repository.is_template : null)
    result.set('repo_visibility', context?.payload?.repository?.visibility || null)
    ...
    result.set('repo_name', context?.payload?.repository?.name || null)
    ...
    result.set('repo_owner_name', context?.payload?.repository?.owner?.login || null)
    result.set('repo_owner_type', context?.payload?.repository?.owner?.type || null)
}
